...
const POSTS: CalendarPost[] = [
  ...
  { day: 4, platform: "Twitter/X", hook: "Unpopular opinion: Consistency beats creativity every time." },
  ...
  { day: 12, platform: "Twitter/X", hook: "Stop creating content. Start building a content system." },
  ...
  { day: 18, platform: "Twitter/X", hook: "Hot take: Your posting frequency means nothing." },
  ...
  { day: 25, platform: "Twitter/X", hook: "Broke: Chasing trends. Woke: Being the trend." },
