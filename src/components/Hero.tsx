  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="animate-float animate-scale-in hero-visual"
          style={{ position: "relative", animationDelay: "0.3s" }}
        >
          {/* Main dashboard card */}
          <div
          ...
          >
            ...
            >
              {["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"].map((d) => (
                <div
                  key={d}
                  style={{ textAlign: "center", fontSize: "0.68rem", color: "rgba(255,255,255,0.35)", paddingBottom: "4px" }}
                >
                  {d}
                </div>
              ))}
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "5px 2px",
                      borderRadius: "6px",
                      background: hasPost ? "rgba(139,92,246,0.07)" : "transparent",
                      display: "flex",
                    ...
                    {hasPost && (
                      <div
                        style={{
                          ...
                          boxShadow: `0 0 5px ${dotColors[i % dotColors.length]}`,
                        }}
                      />
                    )}
                  </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
              {[
                { platform: "IG", abbr: "Instagram", color: "#ec4899", day: "Mon, May 5", hook: '"Stop wasting hours..."' },
                { platform: "TK", abbr: "TikTok", color: "#8b5cf6", day: "Wed, May 7", hook: '"Here\'s what nobody..."' },
                { platform: "LI", abbr: "LinkedIn", color: "#3b82f6", day: "Fri, May 9", hook: '"The truth about..."' },
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: "64px",
                      marginBottom: "8px",
                      background: `linear-gradient(135deg, ${color}25, rgba(0,0,0,0.3))`,
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div style={{ fontSize: "0.58rem", color: color, marginTop: "4px", fontWeight: 600 }}>{day}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 6px 25px rgba(249,115,22,0.45)",
              fontSize: "0.78rem",
              fontWeight: 700,
              color: "#fff",
              animationDelay: "1s",
